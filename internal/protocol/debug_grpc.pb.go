...
const (
	Debug_QueryServer_FullMethodName = "/protocol.Debug/QueryServer"
)
...
func _Debug_QueryServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(DebugServer).QueryServer(ctx, in)
	}
...
var Debug_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protocol.Debug",
	HandlerType: (*DebugServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QueryServer",
			Handler:    _Debug_QueryServer_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/protocol/debug.proto",
}
